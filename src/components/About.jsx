...
const About = () => {
  return (
    <div name="About" className="w-full min-h-auto bg-gradient-to-b from-gray-800 to-black gap-4 sm:gap-6 lg:gap-8 px-4 sm:px-6 lg:px-12 py-6 sm:py-8px-16 lg:px-12">
      <div className="max-w-screen-lg mx-auto px-6 flex flex-row justify-center w-full h-full">
        {/* Image Section */}
        ...
        {/* Text Section */}
        <div className="flex-1 flex flex-col justify-center text-white text-justify lg:ml-8">
